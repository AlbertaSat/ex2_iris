...
struct input_feature img_buffer[10]; //Temporary solution for storing image parameters

/**
 * @brief
 * 		Captures an image with a "width" amount of pixels in the x-direction.
 * @param imgnum
...
int main()
{
        ...
        //Run heuristic calculation on image binary file.
