...
//scfifo ADD_RAM_OUTPUT_REGISTER="OFF" DEVICE_FAMILY="Cyclone V" LPM_NUMWORDS=256 LPM_SHOWAHEAD="OFF" LPM_WIDTH=128 LPM_WIDTHU=8 OVERFLOW_CHECKING="ON" UNDERFLOW_CHECKING="ON" USE_EAB="ON" aclr clock data empty q rdreq wrreq INTENDED_DEVICE_FAMILY="Cyclone V"
...
//a_dpfifo ADD_RAM_OUTPUT_REGISTER="OFF" ALLOW_RWCYCLE_WHEN_FULL="OFF" DEVICE_FAMILY="Cyclone V" LPM_NUMWORDS=256 LPM_SHOWAHEAD="OFF" lpm_width=128 lpm_widthu=8 OVERFLOW_CHECKING="ON" UNDERFLOW_CHECKING="ON" aclr clock data empty q rreq sclr wreq INTENDED_DEVICE_FAMILY="Cyclone V"
//VERSION_BEGIN 20.1 cbx_altdpram 2020:11:11:17:06:45:SJ cbx_altera_counter 2020:11:11:17:06:45:SJ cbx_altera_syncram 2020:11:11:17:06:45:SJ cbx_altera_syncram_nd_impl 2020:11:11:17:06:45:SJ cbx_altsyncram 2020:11:11:17:06:45:SJ cbx_cycloneii 2020:11:11:17:06:45:SJ cbx_fifo_common 2020:11:11:17:06:45:SJ cbx_lpm_add_sub 2020:11:11:17:06:45:SJ cbx_lpm_compare 2020:11:11:17:06:45:SJ cbx_lpm_counter 2020:11:11:17:06:45:SJ cbx_lpm_decode 2020:11:11:17:06:45:SJ cbx_lpm_mux 2020:11:11:17:06:45:SJ cbx_mgl 2020:11:11:17:08:38:SJ cbx_nadder 2020:11:11:17:06:46:SJ cbx_scfifo 2020:11:11:17:06:46:SJ cbx_stratix 2020:11:11:17:06:46:SJ cbx_stratixii 2020:11:11:17:06:46:SJ cbx_stratixiii 2020:11:11:17:06:46:SJ cbx_stratixv 2020:11:11:17:06:46:SJ cbx_util_mgl 2020:11:11:17:06:46:SJ  VERSION_END
...
endmodule //VNIR_ROW_FIFO_cntr

//synthesis_resources = lut 8 reg 10 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  VNIR_ROW_FIFO_a_fefifo
	( 
	aclr,
	clock,
	empty,
...
`endif
	...
	VNIR_ROW_FIFO_cntr   count_usedw
	( 
	.aclr(aclr),
	.clock(clock),
...
endmodule //VNIR_ROW_FIFO_a_fefifo


//altsyncram ADDRESS_ACLR_A="NONE" ADDRESS_ACLR_B="NONE" ADDRESS_REG_B="CLOCK1" DEVICE_FAMILY="Cyclone V" ENABLE_ECC="FALSE" INDATA_ACLR_A="NONE" NUMWORDS_A=256 NUMWORDS_B=256 OPERATION_MODE="DUAL_PORT" OUTDATA_ACLR_B="NONE" OUTDATA_REG_B="UNREGISTERED" RDCONTROL_ACLR_B="NONE" RDCONTROL_REG_B="CLOCK0" READ_DURING_WRITE_MODE_MIXED_PORTS="DONT_CARE" WIDTH_A=128 WIDTH_B=128 WIDTH_ECCSTATUS=2 WIDTHAD_A=8 WIDTHAD_B=8 WRCONTROL_ACLR_A="NONE" address_a address_b clock0 clock1 clocken1 data_a q_b wren_a
...
module  VNIR_ROW_FIFO_altsyncram
	( 
	address_a,
	address_b,
	clock0,
...
endmodule //VNIR_ROW_FIFO_altsyncram
...
`endif
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //VNIR_ROW_FIFO_cntr1

//synthesis_resources = lut 24 M10K 4 reg 26 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  VNIR_ROW_FIFO_a_dpfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	VNIR_ROW_FIFO_a_fefifo   fifo_state
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.sclr(sclr),
	.wreq(wreq));
	VNIR_ROW_FIFO_altsyncram   FIFOram
	( 
	...
	.wren_a(valid_wreq));
	VNIR_ROW_FIFO_cntr1   rd_ptr_count
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_rreq),
...
endmodule //VNIR_ROW_FIFO_a_dpfifo

//synthesis_resources = lut 24 M10K 4 reg 26 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  VNIR_ROW_FIFO_scfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	assign
		...
		q = wire_dpfifo_q,
		sclr = 1'b0;
endmodule //VNIR_ROW_FIFO_scfifo
//VALID FILE
...
module VNIR_ROW_FIFO (
	...
	VNIR_ROW_FIFO_scfifo	VNIR_ROW_FIFO_scfifo_component (
				.aclr (aclr),
				.clock (clock),
				.data (data),
				.rdreq (rdreq),
