...
entity sdram_subsystem is
	port (
		...
		avalon_slave_writedata : in std_logic_vector(127 downto 0)  := (others => '0'); --             .writedata
		avalon_slave_read_n    : in std_logic                       := '0';             -- avalon_slave.read_n
		avalon_slave_readdata  : out std_logic_vector(127 downto 0) := (others => '0'); --             .readdata
...
end architecture rtl; -- of sdram_subsystem
